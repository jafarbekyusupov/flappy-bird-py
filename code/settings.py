...
class Settings:
    def __init__(self):
        ...
        # init w/ default screen size -- medium
        self.current_size = "medium"

        

        # game constants / settings
        self.FPS = 80 # prob gon make it var customizable by user -->> settings dropdown menu
        self.speed = 5
        self.gravity = 0.25
        self.pipe_spawn_time = 1300  # ms
        self.bird_flap_time = 200  # ms
        self.double_click_interval = 0.4  # secs
    ...
    def update_screen_size(self, size):
        """upd settings when screen size changes"""
